<script setup>
    ...
    var labels =  ['Planned', 'Actual', 'Deferred'];
    var options = {
                    responsive: true,
                    plugins: {
                        legend: {
    ...
    const month_1 = ref("1st Quarter");
    const month_2 = ref("2nd Quarter");
    const month_3 = ref("3rd Quarter");
    const month_4 = ref("4th Quarter");
